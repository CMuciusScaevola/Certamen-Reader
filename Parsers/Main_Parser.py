...
st=st.replace("Novice Division - Round 1","").replace("Novice Division - Round 2","").replace("Novice Division - Round 3","").replace("Novice Division Round 1","").replace("Novice Division Round 2","").replace("Novice Division Round 3","").replace("Novice Division Final Round","")
...
st=st.replace("Round 1","").replace("Round 2","").replace("Round 3","").replace("Semifinal Round","").replace("Final Round","").replace("vel sim","").replace("REPLACEMENT TOSSUPS","").replace("ADVANCED DIVISION","").replace("INTERMEDIATE DIVISION","").replace("NOVICE DIVISION","").replace("Novice Division","").replace("ROUND 1","").replace("ROUND 2","").replace("ROUND 3","").replace("FINAL ROUND","").replace("SEMI-FINAL ROUND","").replace("FINALS","")
